...
注意
----
注意点として公式のものから公式**っぽい**もの，独自の調査結果によるものなど信憑性はまちまちです．
...
`i`を**i**nside, `a`のをオブジェクトの**a**round(まわり)まで含むと覚えてたりしてもよいと思いますが公式は"inner"と"a"です．
...
(`zx`とか`zn`,`zN`などは覚えなくてもたいていの動作に支障ないのではという気がする．．．)
